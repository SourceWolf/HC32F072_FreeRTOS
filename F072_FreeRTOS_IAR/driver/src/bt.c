...
en_result_t Bt_Mode0_Init(en_bt_unit_t enUnit, stc_bt_mode0_config_t* pstcConfig)
{
    ...
    pstcM0PBt->M0CR_f.MODE   = pstcConfig->enWorkMode;
    pstcM0PBt->M0CR_f.GATEP  = pstcConfig->enGateP;
    pstcM0PBt->M0CR_f.GATE   = pstcConfig->bEnGate;
    pstcM0PBt->M0CR_f.PRS    = pstcConfig->enPRS;
    pstcM0PBt->M0CR_f.TOGEN  = pstcConfig->bEnTog;
    pstcM0PBt->M0CR_f.CT     = pstcConfig->enCT;
    pstcM0PBt->M0CR_f.MD     = pstcConfig->enCntMode; 
...
en_result_t Bt_Mode1_Init(en_bt_unit_t enUnit, stc_bt_mode1_config_t* pstcConfig)
{
    ...
    pstcM0PBt->M1CR_f.MODE    = pstcConfig->enWorkMode;
    pstcM0PBt->M1CR_f.PRS     = pstcConfig->enPRS;
    pstcM0PBt->M1CR_f.CT      = pstcConfig->enCT;
    pstcM0PBt->M1CR_f.ONESHOT = pstcConfig->enOneShot;
...
en_result_t Bt_Mode23_Init(en_bt_unit_t enUnit, stc_bt_mode23_config_t* pstcConfig)
{
    ...
    pstcM0PBt->M23CR_f.MODE    = pstcConfig->enWorkMode;
    
    pstcM0PBt->M23CR_f.PRS     = pstcConfig->enPRS;
    pstcM0PBt->M23CR_f.CT      = pstcConfig->enCT;
    pstcM0PBt->M23CR_f.COMP    = pstcConfig->enPWMTypeSel;
    pstcM0PBt->M23CR_f.PWM2S   = pstcConfig->enPWM2sSel;
    pstcM0PBt->M23CR_f.ONESHOT = pstcConfig->bOneShot;
    pstcM0PBt->M23CR_f.URS     = pstcConfig->bURSSel;
    pstcM0PBt->M23CR_f.DIR     = pstcConfig->enCntDir;
...
en_result_t Bt_M23_BrakeInput_Config(en_bt_unit_t enUnit, stc_bt_m23_bk_input_config_t* pstcConfig)
{
    ...
    pstcM0PBt->DTR_f.VCE             = pstcConfig->bEnVCBrake;
