 ...
 ** \retval Ok or Error                                      
 *****************************************************************************/
en_result_t Tim3_M23_BrakeInput_Config(stc_tim3_m23_bk_input_config_t* pstcBkConfig)
{
    en_result_t enResult = Ok;
        
    M0P_TIM3_MODE23->DTR_f.BKE             = pstcBkConfig->bEnBrake;
    M0P_TIM3_MODE23->DTR_f.VCE             = pstcBkConfig->bEnVCBrake;
    M0P_TIM3_MODE23->DTR_f.SAFEEN          = pstcBkConfig->bEnSafetyBk;
    M0P_TIM3_MODE23->DTR_f.BKSEL           = pstcBkConfig->bEnBKSync;
    M0P_TIM3_MODE23->CRCH0_f.CFA_CRA_BKSA  = pstcBkConfig->enBkCH0AStat;
    M0P_TIM3_MODE23->CRCH0_f.CFB_CRB_BKSB  = pstcBkConfig->enBkCH0BStat;
    M0P_TIM3_MODE23->CRCH1_f.CFA_CRA_BKSA  = pstcBkConfig->enBkCH1AStat;
    M0P_TIM3_MODE23->CRCH1_f.CFB_CRB_BKSB  = pstcBkConfig->enBkCH1BStat;
    M0P_TIM3_MODE23->CRCH2_f.CFA_CRA_BKSA  = pstcBkConfig->enBkCH2AStat;
    M0P_TIM3_MODE23->CRCH2_f.CFB_CRB_BKSB  = pstcBkConfig->enBkCH2BStat;
    M0P_TIM3_MODE23->FLTR_f.BKP            = pstcBkConfig->enBrakePolarity;
    M0P_TIM3_MODE23->FLTR_f.FLTBK          = pstcBkConfig->enBrakeFlt;
