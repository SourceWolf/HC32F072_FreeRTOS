...
/**
 *******************************************************************************
 ** \brief 置位所有外设，使所有模块处于正常工作状态.
 ** 
 ** \retval  Null
 ******************************************************************************/
void Reset_SetPeripheralAll(void)
{
...
/**
 *******************************************************************************
 ** \brief 清除所有外设复位,使模块处于复位状态.
 **
 ** 
 ** \retval  Null
 ******************************************************************************/
void Reset_ClrPeripheralAll(void)
{
...
/**
 *******************************************************************************
 ** \brief 置位外设复位源0开关,使模块处于正常工作状态.
 **
 ** \param [in]  enPeri  @ref en_reset_peripheral0_t
 ** 
 ** \retval  Null
 ******************************************************************************/
void Reset_SetPeripheral0(en_reset_peripheral0_t enPeri)
{
...
/**
 *******************************************************************************
 ** \brief 置位外设复位源1开关，使模块处于正常工作状态.
 **
 ** \param [in]  enPeri  @ref en_reset_peripheral1_t
 ** 
 ** \retval  Null
 ******************************************************************************/
void Reset_SetPeripheral1(en_reset_peripheral1_t enPeri)
{
 ...
 ** \retval  Null
 ******************************************************************************/
void Reset_ClrPeripheral0(en_reset_peripheral0_t enPeri)
{
    M0P_RESET->PERI_RESET0 &= ~(uint32_t)enPeri;
}
...
/**
 *******************************************************************************
 ** \brief 清除外设复位源1开关，使模块处于复位状态.
 **
 ** \param [in]  enPeri  @ref en_reset_peripheral1_t
 ** 
 ** \retval  Null
 ******************************************************************************/
void Reset_ClrPeripheral1(en_reset_peripheral1_t enPeri)
{
    M0P_RESET->PERI_RESET1 &= ~(uint32_t)enPeri;
}
