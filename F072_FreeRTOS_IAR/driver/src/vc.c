...
******************************************************************************
	...
	**
******************************************************************************/
void Vc_ConfigItType(en_vc_channel_t Channelx, en_vc_irq_sel_t ItType)
{
...
******************************************************************************
	...
	**
******************************************************************************/
void  Vc_ItConfig(en_vc_channel_t Channelx, boolean_t NewStatus)
{
	switch(Channelx)
	{
		case VcChannel0:
...
******************************************************************************
	...
	**
******************************************************************************/
void Vc_Init(stc_vc_channel_config_t *pstcChannelConfig)
{
    if (VcChannel0 == pstcChannelConfig->enVcChannel)
    {
        ...
        M0P_VC->VC0_CR_f.N_SEL = pstcChannelConfig->enVcInPin_N;
				M0P_VC->VC0_CR_f.FLTEN = pstcChannelConfig->bFlten;
        M0P_VC->VC0_OUT_CFG = 1<<pstcChannelConfig->enVcOutConfig;
    }
    else if (VcChannel1 == pstcChannelConfig->enVcChannel)
    {
        ...
        M0P_VC->VC1_CR_f.N_SEL = pstcChannelConfig->enVcInPin_N;
				M0P_VC->VC1_CR_f.FLTEN = pstcChannelConfig->bFlten;
        M0P_VC->VC1_OUT_CFG = 1<<pstcChannelConfig->enVcOutConfig;
    }
		else if(VcChannel2 ==  pstcChannelConfig->enVcChannel)
		{
        M0P_VC->CR_f.VC2_HYS_SEL = pstcChannelConfig->enVcCmpDly;
        M0P_VC->CR_f.VC2_BIAS_SEL = pstcChannelConfig->enVcBiasCurrent;
        M0P_VC->VC2_CR_f.DEBOUNCE_TIME = pstcChannelConfig->enVcFilterTime;
        M0P_VC->VC2_CR_f.P_SEL = pstcChannelConfig->enVcInPin_P;
        M0P_VC->VC2_CR_f.N_SEL = pstcChannelConfig->enVcInPin_N;
				M0P_VC->VC2_CR_f.FLTEN = pstcChannelConfig->bFlten;
        M0P_VC->VC2_OUT_CFG = 1<<pstcChannelConfig->enVcOutConfig;			
		}
        else
        {
            ;
