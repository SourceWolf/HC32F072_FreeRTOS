...
typedef enum
{
    CanExternalLoopBackMode  = 0x40u,        ///< Loop back mode, external
    CanInternalLoopBackMode  = 0x20u,        ///< Loop back mode, internal
    CanTxSignalPrimaryMode   = 0x10u,        ///< Transmission primary single shot mode for PTB
    CanTxSignalSecondaryMode = 0x08u,        ///< Transmission secondary single shot mode for STB
    CanListenOnlyMode        = 0xFFu,        ///< Listen only mode
}en_can_mode_t;
