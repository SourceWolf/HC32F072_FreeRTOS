 ...
 ******************************************************************************/
extern void Vc_ConfigItType(en_vc_channel_t Channelx, en_vc_irq_sel_t ItType);
extern void  Vc_ItConfig(en_vc_channel_t Channelx, boolean_t NewStatus);
extern boolean_t Vc_GetItStatus(en_vc_ifr_t Result);
extern void Vc_ClearItStatus(en_vc_ifr_t NewStatus);
extern en_result_t Vc_DacInit(stc_vc_dac_config_t *pstcDacConfig);
extern void Vc_Init(stc_vc_channel_config_t *pstcChannelConfig);
