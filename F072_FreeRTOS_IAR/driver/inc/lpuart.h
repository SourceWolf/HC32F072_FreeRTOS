...
{
    LPUartMsk_Pclk   = 0u<<11, ///<pclk
    LPUartMsk_Xtl    = 2u<<11, ///<外部低速晶振
    LPUartMsk_Rcl    = 3u<<11, ///<内部低速晶振
} en_lpuart_sclksel_t;
...
typedef struct stc_lpuart_baud
{
    ...
    en_lpuart_clkdiv_t   enSclk_Div;     ///<采样分频选择 
...
//LPUART通道多机模式设置函数
en_result_t LPUart_SetMMDOrCk(M0P_LPUART_TypeDef* LPUARTx,en_lpuart_mmdorck_t enTb8);
